...
export class CategoryListComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // we are using a debounceTime(1000) in the searchValueChanged, 
    //and this is because with that we can set a timer to this property, 
    //so when the user types something in the searching field,
    // it will wait some seconds to do the searching, otherwise if we do not do this,
    // for each letter the user type it would be executed a search operation.
